...
- Bump `@metamask/controller-utils` from `^12.1.0` to `^12.2.0` ([#TBD](https://github.com/MetaMask/smart-transactions-controller/pull/TBD))
- Bump `@metamask/profile-sync-controller` from `^28.1.0` to `^28.1.1` ([#TBD](https://github.com/MetaMask/smart-transactions-controller/pull/TBD))
- Bump `@metamask/remote-feature-flag-controller` from `^4.2.1` to `^4.2.2` ([#TBD](https://github.com/MetaMask/smart-transactions-controller/pull/TBD))
- Bump `@metamask/utils` from `^11.0.0` to `^11.11.0` ([#TBD](https://github.com/MetaMask/smart-transactions-controller/pull/TBD))
